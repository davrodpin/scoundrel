...
Deno.test("returns near the top label for 1%", () => {
  assertEquals(
    ...
    { label: "Near the top of the Leaderboard", percent: "(top 1%)" },
  );
});
...
Deno.test("returns near the top label for 10%", () => {
  assertEquals(
    ...
    { label: "Near the top of the Leaderboard", percent: "(top 10%)" },
  );
});
...
Deno.test("returns upper ranks label for 11%", () => {
  assertEquals(
    ...
    { label: "In the upper ranks of the Leaderboard", percent: "(top 11%)" },
  );
});
...
Deno.test("returns upper ranks label for 25%", () => {
  assertEquals(
    ...
    { label: "In the upper ranks of the Leaderboard", percent: "(top 25%)" },
  );
});
...
Deno.test("returns upper half label for 26%", () => {
  assertEquals(
    ...
    { label: "In the upper half of the Leaderboard", percent: "(top 26%)" },
  );
});
...
Deno.test("returns upper half label for 50%", () => {
  assertEquals(
    ...
    { label: "In the upper half of the Leaderboard", percent: "(top 50%)" },
  );
});
...
Deno.test("returns lower half label for 51%", () => {
  assertEquals(
    ...
    { label: "In the lower half of the Leaderboard", percent: "(top 51%)" },
  );
});
...
Deno.test("returns lower half label for 75%", () => {
  assertEquals(
    ...
    { label: "In the lower half of the Leaderboard", percent: "(top 75%)" },
  );
});
...
Deno.test("returns near the bottom label for 76%", () => {
  assertEquals(
    ...
    { label: "Near the bottom of the Leaderboard", percent: "(top 76%)" },
  );
});
...
Deno.test("returns near the bottom label for 90%", () => {
  assertEquals(
    ...
    { label: "Near the bottom of the Leaderboard", percent: "(top 90%)" },
  );
});
...
Deno.test("returns close to the bottom label for 91%", () => {
  assertEquals(
    ...
    { label: "Close to the bottom of the Leaderboard", percent: "(top 91%)" },
  );
});
...
Deno.test("returns close to the bottom label for 100%", () => {
  assertEquals(
    ...
    { label: "Close to the bottom of the Leaderboard", percent: "(top 100%)" },
  );
});
